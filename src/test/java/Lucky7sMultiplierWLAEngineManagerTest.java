...
public class Lucky7sMultiplierWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(Lucky7sMultiplierWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/Lucky7sMultiplierWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/Lucky7sMultiplierWLAIW/InitOutcome.xml").getDocumentElement();
